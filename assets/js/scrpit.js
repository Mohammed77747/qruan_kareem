...
moshafs.forEach( moshaf => {
        chooseMoshaf.innerHTML  += `<Option  value="${moshaf.id}"data-server="${moshaf.server}"data-surahList="${moshaf.surah_list}"  >${moshaf.name}
        </Option>`
});
...
async function  getSurah(surahServer,surahList) {
        ...
        chooseSurah.addEventListener('change', a => {
